# Define Resource Type: dkr::mysql_grant
#
...
#
# Sample Usage:
#   dkr::mysql_grant { ['hostname1', 'hostname2'] :
...
#
#
define dkr::mysql_grant($username, $password, $database, $privileges) {
  ...
  ensure_resource('mysql_grant', "${username}@${host}/${database}.*", $grant_resource)
}
