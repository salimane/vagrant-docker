...
#
# Sample Usage:
#   class { 'dkr::mysql' : env => 'staging' }
#
#
class dkr::mysql($env = 'development') {
  ...
  dkr::mysql_grant { $account[$env]['access'] :
  ...
  dkr::mysql_grant { $account['test']['access'] :
  ...
  dkr::mysql_grant { $account['staging']['access'] :
  ...
  dkr::mysql_grant { $account['production']['access'] :
