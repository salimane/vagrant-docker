# Class: dkr::sysctl
#
# This class sets Sysctl configuration for all dkr nodes
#
# Parameters:
#
# Actions:
...
class dkr::sysctl {
  ...
  # setting limits
  dkr::basic::set_limits { 'any-soft': domain => '*', type => soft, item => nofile, value =>  65536 }
  dkr::basic::set_limits { 'any-hard': domain => '*', type => hard, item => nofile, value =>  65536 }
